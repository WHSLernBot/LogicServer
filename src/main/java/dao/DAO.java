...
//            + "MODUL_UNI_ID = UNI_ID and KLAUSUR_PERIODE_UNI_ID = UNI_ID and "
    ...
    /**
     * Prueft ob ein Benutzer fuer ein Modul angemeldet ist.
     * @param b
     * @param m
     * @return Falls true, so ist er angemeldet.
     */
...
//            qPeriode.setParameter("HEUTE", new Date(gibDatum().getTime() - 48 * 60 * 60 * 1000),TemporalType.DATE);
    ...
    /**
     * Diese Methode schreibt eine neue Adresse eines Node.js unter der
     * gegebenen Nummer ein.
     * 
     * 1 = Facebook
     * 
     * @param nummer Nummer der Plattform
     * @param url Adresse des Node.js
     * @return Lediglich zu Testzwecken.
     * @throws Exception 
     */
